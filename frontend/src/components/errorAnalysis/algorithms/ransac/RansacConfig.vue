  ...
  >
    ...
    <template #content>
      <div class="gd-config-content">
        ...
        <!-- RANSAC 专属参数 -->
        <div class="config-section">
          <h4 class="section-title">RANSAC 参数</h4>
          <div class="subsection">
            <div class="form-row">
              <div class="form-group">
                <label class="form-label">残差阈值（度）</label>
                <input
                  v-model.number="localConfig.residual_threshold"
                  type="number"
                  step="0.01"
                  min="0.01"
                  max="5"
                  ...
                  :disabled="disabled"
                />
                <span class="field-hint">小于此值的观测点被视为内点</span>
              </div>
              <div class="form-group">
                <label class="form-label">最小样本数</label>
                <input
                  v-model.number="localConfig.min_samples"
                  type="number"
                  step="1"
                  min="2"
                  max="10"
                  ...
                  :disabled="disabled"
                />
                <span class="field-hint">认定一组数据有效所需的最少点数</span>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="form-label">离群率阈值</label>
                <input
                  v-model.number="localConfig.outlier_ratio_threshold"
                  type="number"
                  step="0.05"
                  min="0.1"
                  max="0.9"
                  ...
                  :disabled="disabled"
                />
                <span class="field-hint">超过此阈值判定为故障站</span>
              </div>
            </div>
          </div>
        </div>
...
const presetDescriptions: Record<string, string> = {
  standard: '默认参数，平衡精度与速度',
  strict: '严格模式，更低的残差阈值，更易识别离群站',
  loose: '宽松模式，容忍较大偏差',
  fast: '快速分析，降低精度要求提升速度',
}

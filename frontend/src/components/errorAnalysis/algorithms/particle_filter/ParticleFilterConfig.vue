        ...
        <div class="section">
          ...
          <div class="subsection">
            <div class="form-group">
              <label>粒子数量</label>
              <input v-model.number="localConfig.num_particles" type="number" step="100" min="100" max="10000" class="form-input" :disabled="disabled" />
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>过程噪声标准差</label>
                <input v-model.number="localConfig.process_noise_std" type="number" step="0.0001" min="0.0001" max="1" class="form-input" :disabled="disabled" />
              </div>
              <div class="form-group">
                <label>测量噪声标准差</label>
                <input v-model.number="localConfig.measurement_noise_std" type="number" step="0.001" min="0.0001" max="1" class="form-input" :disabled="disabled" />
              </div>
            </div>
            <div class="form-group">
              <label>重采样方法</label>
              <select v-model="localConfig.resampling_method" class="form-input" :disabled="disabled">
                <option value="systematic">系统重采样</option>
                <option value="multinomial">多项式重采样</option>
              </select>
            </div>
          </div>
        </div>
...
const descMap: Record<string, string> = { standard: '1000粒子，平衡精度与速度', high_precision: '5000粒子，高精度', fast: '200粒子，快速' }
